...
<header>
	<ul>
        ...
        <li class="signuplink">
            <a class="<?php echo ($current_page == 'signup.php') ? 'active' : NULL ?>" href="signup.php">Sign Up</a>
        </li>
        <li class="signuplink">
            <a class="<?php echo ($current_page == 'login.php') ? 'active' : NULL ?>" href="login.php">Log In</a>
        </li>
    </ul>
    <?php
        session_start();
